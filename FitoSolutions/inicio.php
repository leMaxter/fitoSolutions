<div id="hero-carousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active c-carousel">
            <img class="d-block w-100 c-img" src="assets/img/olivo.jpeg" alt="First slide">
        ...
        <div class="carousel-item c-carousel">
            <img class="d-block w-100 c-img" src="assets/img/plaga.jpeg" alt="Second slide">
            <div class="carousel-caption top-1 mt-5 d-none d-md-block">
        ...
        <div class="carousel-item c-carousel">
            <img class="d-block w-100 c-img" src="assets/img/semilla.jpg" alt="Third slide">
            <div class="carousel-caption top-1 mt-5 d-none d-md-block">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 mb-2 mt-5 d-flex">
                <div class="card flex-fill" onclick="location.href='atencionCliente.html';">
                    <img src="assets/img/servicio1.jpg" class="card-img-top" alt="Atención al cliente" />
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6 mb-2 mt-5 d-flex">
                <div class="card flex-fill" onclick="location.href='';">
                    <img src="assets/img/servicio2.jpeg" class="card-img-top" alt="Fertilizantes" />
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6 mb-2 mt-5 d-flex">
                <div class="card flex-fill" onclick="location.href='';">
                    <img src="assets/img/servicio3.jpg" class="card-img-top" alt="Vuelos" />
                    <div class="card-body">
            ...
            <div class="col-lg-3 col-sm-6 mb-2 mt-5 d-flex">
                <div class="card flex-fill" onclick="location.href='';">
                    <img src="assets/img/servicio4.jpeg" class="card-img-top" alt="Vuelos" />
                    <div class="card-body">
...
<div class="videoFondo">
    <video autoplay muted loop id="videoCampo">
        <source src="assets/video/videoPrueba.mp4" type="video/mp4">
    </video>
